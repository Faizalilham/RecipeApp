...
//    val viewModel = viewModel { DetailViewModel(repository) }
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(
                        ...
                        Icon(
                            modifier = Modifier.alpha(if(selectedRecipe.isFavorite) 1f else 0.2f),
        ...
        Column(
            ...
            Row(
                ...
                SuggestionChip(
                    ...
                    label = {
                        Text(
                            text = "${selectedRecipe.preparationTime} Minutes",
